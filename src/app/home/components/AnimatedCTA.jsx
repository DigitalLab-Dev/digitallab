  ...
  useEffect(() => {
    ...
    const animateFloatingElements = () => {
      floatingElementsRef.current.forEach((el, index) => {
        ...
        el.style.animation = `float-${index % 3} ${6 + Math.random() * 4}s ease-in-out infinite, rotate ${8 + Math.random() * 4}s linear infinite`;
      });
    };
    ...
    const animateParticles = () => {
      particlesRef.current.forEach((particle, index) => {
        ...
        particle.style.animation = `rise ${3 + Math.random() * 2}s linear infinite ${Math.random() * 2}s`;
      });
    };
    ...
    <>
      ...
      <style jsx>{`
        ...
        @keyframes float-2 {
          ...
          40% { transform: translateY(-45px) translateX(-5px); }
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <FloatingSVG index={1} className="text-white">
            <svg width="120" height="120" viewBox="0 0 80 80" className="w-full h-full">
              <circle
                cx="40"
                cy="40"
                r="30"
          ...
          <FloatingSVG index={2} className="text-orange-500">
            <svg width="120" height="120" viewBox="0 0 100 100" className="w-full h-full">
              <polygon
          ...
          <FloatingSVG index={3} className="text-white">
            <svg width="120" height="120" viewBox="0 0 60 60" className="w-full h-full">
              <path
        ...
        <div className="container mx-auto px-6 text-center relative z-10 max-w-6xl">
          <div className="space-y-8">
            ...
            {/* Main Title */}
            <h1 ref={mainTitleRef} className="content-animate text-4xl md:text-6xl lg:text-7xl font-black text-white leading-tight">
            ...
            {/* Description */}
            <p ref={descriptionRef} className="content-animate text-gray-300 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Partner with our expert team to create innovative solutions that drive growth, 
              engage your audience, and transform your digital presence.
            </p>

            {/* CTA Buttons */}
            <div ref={ctaButtonsRef} className="content-animate flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
              <button className="group relative px-8 py-4 bg-gradient-to-r from-orange-400 to-orange-600 text-white font-bold text-lg rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/25">
              ...
              <button className="group px-8 py-4 bg-transparent text-white font-bold text-lg rounded-full border-2 border-white hover:scale-105 hover:border-orange-500 hover:text-orange-500 transition-all duration-300">
            ...
            {/* Trust Indicators */}
            <div ref={trustIndicatorsRef} className="content-animate mt-16 trust-indicators">
              <p className="text-gray-400 text-sm mb-6">Trusted by 500+ companies worldwide</p>
