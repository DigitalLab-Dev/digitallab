...
const ServiceCard = ({ 
  ...
  return (
    <motion.div
      ref={cardRef}
      className="relative w-full sm:w-[350px] h-[400px] bg-transparent rounded-xl overflow-hidden  border-orange-500/20 shadow-2xl transition-all duration-300 ease-out"
      onMouseMove={handleMouseMove}
