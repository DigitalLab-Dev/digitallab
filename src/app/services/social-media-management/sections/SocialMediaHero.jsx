...
// import { ArrowRight, Play, TrendingUp, Users, Heart, MessageCircle, Share2, Star } from 'lucide-react';
...
//           style={{
//             background: `
//               radial-gradient(circle at 20% 30%, #f97316 0%, transparent 50%),
//               radial-gradient(circle at 80% 20%, #fb923c 0%, transparent 50%),
//               radial-gradient(circle at 40% 70%, #fdba74 0%, transparent 50%),
//               radial-gradient(circle at 90% 80%, #fed7aa 0%, transparent 50%)
//             `
//           }}
//           animate={{
//             scale: [1, 1.1, 1],
...
//           >
//             <motion.button
//               className="group relative p-4 bg-gradient-to-r from-orange-500 to-amber-500 text-black font-bold text-lg rounded-full overflow-hidden shadow-2xl"
