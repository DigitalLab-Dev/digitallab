...
//     },
//     {
//       id: 9, name: "TravelWise", imageUrl: "/logos/logo4.png",
//       category: "Travel", year: "2022", projects: "9+"
//     }
//   ];
//   useEffect(() => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <motion.div 
                          className="w-full h-full rounded-full p-3 backdrop-blur-md border-2"
                          // animate={{
                          //   background: isActive 
                          //     ? "rgba(255, 255, 255, 1)"
                          ...
                          transition={{ duration: 0.3 }}
                        >
                          <div className="w-full h-full flex items-center justify-center bg-black rounded-xl overflow-hidden p-2">
                            <img
                              src={logo.imageUrl}
                              alt={logo.name}
                              ...
                              onError={(e) => {
                                e.target.src = `https://via.placeholder.com/100x100/f97316/ffffff?text=${logo.name}`;
                              }}
                            />
                          </div>
                        </motion.div>
                      ...
                      >
                        <div className="w-full h-full rounded-2xl bg-gradient-to-br from-orange-500 to-amber-500 p-1 shadow-2xl">
                          <div className="w-full h-full bg-black rounded-xl flex flex-col items-center justify-center text-white text-center px-3">
                            <div className="font-bold text-sm mb-1 truncate w-full">{logo.name}</div>
                            <div className="text-orange-400 text-xs font-semibold">{logo.projects}</div>
                            <div className="text-white/70 text-[10px] mt-1">{logo.year}</div>
                          </div>
                        </div>
