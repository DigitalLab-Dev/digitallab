...
export default function ClientsPageClient({ initialInfluencers, initialTestimonials }) {
  ...
  return (
    <>
      ...
      >
        ...
        <InfluencerShowcase initialInfluencers={initialInfluencers} />

        {/* Testimonials - Client Reviews */}
        <TestimonialCarousel initialTestimonials={initialTestimonials} />
